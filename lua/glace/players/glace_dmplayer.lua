...
CreateConVar( "glacedmbots_notaunt", 0, FCVAR_ARCHIVE, "If the bots shouldn't talk in voice chat", 0, 1 )
CreateConVar( "glacedmbots_refresh", 0, FCVAR_ARCHIVE, "If the bots should kick themselves and rejoin on death", 0, 1 )
...
function SpawnDMGlacePlayer()
	...
	function ply:Glace_radio( radiotype )
		...
		if GetConVar( "glacedmbots_notaunt" ):GetBool(0) then return end
    ...
    function ply:Glace_OnKilled( attacker, inflictor )
		...
		if GetConVar( "glacedmbots_refresh" ):GetBool(1) then
    ...
    function ply:Glace_Think()
        ...
        local surrounding = self:Glace_FindInSphere( 1500, function(ent) if IsValid(ent) and (ent:IsNPC() or ent:IsPlayer()) and self:Glace_CanSee( ent ) and ent:Alive() then return true end end ) -- Get Nearby NPCs and Players we can see
